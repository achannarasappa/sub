...
yargs
  ...
  .alias('h', 'help')
  .help()
  .command('* <file_pattern> [options...]', 'Shell-esque parameter substitution in files from env and text data sources', (yargs) => {

    yargs.positional('file_pattern', {
      describe: 'file glob pattern e.g. *.json',
      type: 'string',
    })
